...
import cv2
import numpy as np
input_img = cv2.imread(r"C:\Users\mohak\Desktop\New folder\xored_image_fresh_test.png")
...
final_function(g)
final_function(r)
c_a_img=cv2.merge((b,g,r))
cv2.imshow('post CA img',c_a_img)
file_name='CA ke baad img.png'
#path='D:\FINAL PROJECT COMPILED\output images'
cv2.imwrite(file_name,c_a_img)
cv2.waitKey(0)
cv2.destroyAllWindows